...
import tororo1066.nmsutils.v1_21_8.command.CommandArgumentsImpl
        ...
        val builder = RequiredArgumentBuilder.argument<CommandSourceStack, T>(command.name, argumentType).apply {
            if (command.suggests.isNotEmpty()) {
                suggests { context, suggestionsBuilder ->
                    val suggestions = command.suggests.flatMap { it(SCommandV2Data(context.source.bukkitSender, context.input.split(" ")[0],
